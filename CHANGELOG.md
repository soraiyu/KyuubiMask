...
### Fixed
- Masking service no longer requires a device restart to recover when it stops working after extended use: opening the app now automatically re-establishes the listener connection

...
/**
 * Masking strategy dedicated to Telegram.
 *
 * Since Telegram notifications contain contact names and message bodies,
 * their content is masked to protect user privacy.
 * Currently uses the generic masking logic of AbstractMaskStrategy.
 */
class TelegramMaskStrategy : AbstractMaskStrategy() {

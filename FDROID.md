...
### Git Tag
- **Status**: ✅ `v1.5.0` tag exists and points to the correct commit on `main`
- F-Droid builds from `commit: v1.5.0` as specified in the metadata YAML
...
- [x] `v1.5.0` git tag exists on `main`
...
- [x] Fastlane changelogs added for v1.5.0 (`fastlane/metadata/android/<locale>/changelogs/9.txt`)
...
5. F-Droid maintainers will review, build the APK from tag `v1.5.0`, and publish it.

...
0. **Obtainium** から（自動アップデート付き・推奨）
1. **GitHub Actions の Artifacts** から（開発版・Debug APK）
2. **GitHub Releases** から（リリース版・Release APK）

---

## 📲 方法0: Obtainium を使う（推奨）

[Obtainium](https://github.com/ImranR98/Obtainium) は、GitHub Releases から直接アプリをインストール・自動更新できるAndroidアプリです。

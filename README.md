...
[![Obtainium](https://img.shields.io/badge/Get%20it%20on-Obtainium-cyan)](https://apps.obtainium.imranr.dev/redirect?r=obtainium://app/%7B%22id%22%3A%22com.rtneg.kyuubimask%22%2C%22url%22%3A%22https%3A%2F%2Fgithub.com%2Fsoraiyu%2FKyuubiMask%22%2C%22author%22%3A%22soraiyu%22%2C%22name%22%3A%22KyuubiMask%22%2C%22preferredApkIndex%22%3A0%2C%22additionalSettings%22%3A%22%7B%5C%22includePrereleases%5C%22%3Afalse%2C%5C%22fallbackToOlderReleases%5C%22%3Atrue%2C%5C%22filterReleaseTitlesByRegEx%5C%22%3A%5C%22%5C%22%2C%5C%22filterReleaseNotesByRegEx%5C%22%3A%5C%22%5C%22%2C%5C%22verifyLatestTag%5C%22%3Afalse%2C%5C%22dontSortReleasesList%5C%22%3Afalse%2C%5C%22useLatestAssetDateAsReleaseDate%5C%22%3Afalse%2C%5C%22trackOnly%5C%22%3Afalse%2C%5C%22versionDetection%5C%22%3Atrue%2C%5C%22releaseTitleAsVersion%5C%22%3Afalse%2C%5C%22castNonInstallableLinksAsDownloadLinks%5C%22%3Afalse%2C%5C%22autoApkFilterByArch%5C%22%3Atrue%2C%5C%22appName%5C%22%3A%5C%22%5C%22%2C%5C%22shizukuPretendToBeGooglePlay%5C%22%3Afalse%2C%5C%22allowInsecure%5C%22%3Afalse%2C%5C%22exemptFromBackgroundUpdates%5C%22%3Afalse%2C%5C%22skipUpdateNotifications%5C%22%3Afalse%2C%5C%22about%5C%22%3A%5C%22%5C%22%7D%22%2C%22apkFilterRegEx%22%3A%22app-release%5C%5C.apk%22%2C%22overrideSource%22%3Anull%7D)
...
**KyuubiMask is designed to keep your notification content away from prying eyes. It replaces notification text as quickly as possible, making it much harder for others to read what you receive—even if they're looking at your screen.** Notification content is never displayed or saved by this app.

KyuubiMask protects your privacy in everyday situations—on trains, at work, around family and friends, or in cafes. It prevents sensitive notification content from being exposed when someone looks over your shoulder, appears on your lock screen, or gets captured in screenshots. Tapping a masked notification opens the original app directly, without revealing any content. Whether you're commuting, working in an office, or relaxing at home, KyuubiMask ensures your private messages stay private.
...
- 🔲 **Quick Settings Tile** - Toggle masking on/off with one tap from the notification shade
- 🎛️ **Home Screen Toggle** - Large Compose-based switch on the main screen for quick control
- 📳 **Vibration Pattern Selection** - Choose from short, double, heart, or long vibration patterns for masked notifications
...
- ✅ **Fully Open Source** - MIT license, all code is reviewable
...
> **💡 Want to check a notification later?**
> This app never saves notification content. On supported devices (Android 11+), you can review what you received using Android's built-in **Notification History**, if available and enabled (Settings → Notifications → Notification History).
...
**KyuubiMaskは、通知内容を他人に読まれるリスクをできる限り減らすために設計されています。通知を受信するとすぐに内容を一般テキストへ置き換えることで、他人に画面を見られても中身が読まれにくくなります。** 通知内容はこのアプリによって一切表示・保存されません。

KyuubiMaskは、電車の中、職場、家族や友人の近く、カフェなど、日常のあらゆる場面であなたのプライバシーを守ります。肩越しに覗かれる、ロック画面にそのまま表示される、スクリーンショットに写り込むといった日常的なリスクから、機密性の高い通知内容を保護します。マスクされた通知をタップすると、内容を見せずに元のアプリが開きます。返信などの操作は、開いたアプリ内で通常どおり行えます。通勤中でも、オフィスでも、自宅でリラックスしている時でも、KyuubiMaskがあなたのプライベートメッセージをしっかり守ります。
...
- 🎯 **ほとんどのアプリに対応** - ほとんどのインストール済みアプリに対応。Slack・Discord・WhatsApp・LINEはプリセットとして利用可能
- 🌍 **F-Droid準拠** - オープンソース、トラッキングなし
- ⚡ **軽量** - 最小限のメモリフットプリントとバッテリー影響
- 🔋 **バッテリー効率** - 継続的なバックグラウンド動作に最適化
- 🔲 **クイック設定タイル** - 通知シェードからワンタップでマスキングのON/OFFを切り替え
- 🎛️ **ホーム画面トグル** - メイン画面のCompose製大型スイッチで素早く操作
- 📳 **バイブレーションパターン選択** - マスクされた通知のバイブをshort/double/heart/longから選択可能

### 対応アプリ

KyuubiMaskは**ほとんどのインストール済みアプリ**に対応しています。設定画面の「カスタムアプリを追加…」ボタンからマスク対象を追加できます。
...
6. 通知内容が「新しい通知」に置き換わることを確認

> **💡 通知内容をあとで見たい場合は？**
> このアプリは通知内容を一切保存しません。あとで内容を確認したい場合は、Android標準の「通知履歴」（設定 → 通知 → 通知履歴）をご利用ください（※ Android 11 以降の一部端末でのみ利用可能です。ご利用には設定での有効化が必要な場合があります）。
